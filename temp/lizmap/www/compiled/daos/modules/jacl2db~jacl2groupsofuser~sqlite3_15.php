...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('/var/www/lizmap-web-client-3.5.5/lib/jelix-modules/jacl2db/daos/jacl2groupsofuser.dao.xml') > 1658398566)){ return false;
}
else {
...
public function update ($record){
     throw new jException('jelix~dao.error.update.impossible',array('jacl2db~jacl2groupsofuser','/var/www/lizmap-web-client-3.5.5/lib/jelix-modules/jacl2db/daos/jacl2groupsofuser.dao.xml'));
 }
