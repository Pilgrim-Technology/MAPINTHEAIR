...
filemtime('/var/www/lizmap-web-client-3.5.5/lizmap/modules/lizmap/templates/wmts_capabilities.tpl') > 1616160726){ return false;
} else {
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/common/modifier.number_format.php');
