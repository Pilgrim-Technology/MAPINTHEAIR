...
filemtime('/var/www/lizmap-web-client-3.5.5/lizmap/modules/view/templates/map_geobookmark.tpl') > 1616160726){ return false;
} else {
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/html/function.jmessage.php');
