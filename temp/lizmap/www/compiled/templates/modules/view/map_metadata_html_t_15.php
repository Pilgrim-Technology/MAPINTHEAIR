...
filemtime('/var/www/lizmap-web-client-3.5.5/lizmap/modules/view/templates/map_metadata.tpl') > 1658139367){ return false;
} else {
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/html/function.jurl.php');
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/html/modifier.nl2br.php');
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/common/modifier.replace.php');
