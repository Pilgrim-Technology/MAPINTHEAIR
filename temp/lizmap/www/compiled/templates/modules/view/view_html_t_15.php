...
filemtime('/var/www/lizmap-web-client-3.5.5/lizmap/modules/view/templates/view.tpl') > 1658139367){ return false;
} else {
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/html/meta.html.php');
 require_once('/var/www/lizmap-web-client-3.5.5/lib/jelix/plugins/tpl/common/modifier.truncate.php');
