...
filemtime('/var/www/lizmap-web-client-3.5.5/lizmap/var/themes/default/jauthdb_admin/crud_view.tpl') > 1658398566){ return false;
} else {
 require_once('/var/www/lizmap-web-client-3.5.5/lizmap/plugins/tpl/html/function.formdatafull_bootstrap.php');
